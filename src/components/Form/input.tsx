...
type InputPefixProps = ComponentProps<'div'>

export function Prefix(props: InputPefixProps) {
  return <div {...props} />
}
  ...
  return (
    <div
      className={twMerge(
        ...
        'dark:border-zin-700 dark:bg-zinc-800 dark:focus-within:border-violet-500 dark:focus-within:ring-violet-500/20',
        props.className,
      )}
      {...props}
    />
